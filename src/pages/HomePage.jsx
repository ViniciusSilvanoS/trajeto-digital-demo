...
const HomePage = () => {
  return (
    <div className='bg-[#0F172A] flex flex-col min-h-screen w-full relative overflow-hidden'>
        <img src={BlurPurple} className='pointer-events-none absolute -top-72 -left-72' alt="Desfoque roxo de fundo" />
        <img src={BlurBlue}  className='pointer-events-none absolute top-0 right-0 h-[700px] w-[600px]' alt="Desfoque azul de fundo" />
        <NavBar />
